...
const translations = {
  zh: {
    ...
    "projects.topco.title": "NTPU × 崇越 AI 數位轉型",
    "projects.topco.desc":"協助企業導入 AI 教育訓練、產業應用諮詢及數位轉型解決方案。",
    "projects.topco.preview":"NTPU × TOPCO AI Project",
    "common.live": "已上線",
    "common.preview": "瀏覽網站 ↗",
  ...
  en: {
    ...
    "projects.sports.preview": "AI Sports Office Assistant",
    "projects.topco.title":"NTPU × TOPCO AI Digital Transformation",
    "projects.topco.desc":"Providing AI training, industry consulting and digital transformation solutions for enterprises.",
    "projects.topco.preview":"NTPU × TOPCO AI Project",
    "common.live": "Live",
